...
function changeToggleIcon() {
  if (navMenu.classList.contains("nav__menu--open")) {
    navToggle.classList.replace("ri-menu-4-line", "ri-close-line","ri-eye-2-line");
  } else {
    navToggle.classList.replace("ri-close-line", "ri-menu-4-line","ri-eye-2-line");
  }
}
...
const enableDarkTheme = () => {
  ...
  themeToggle.classList.replace("ri-moon-line", "ri-sun-line","ri-eye-2-line");
...
const contrast = () => {
  // Add the contrast class to the body
  document.body.classList.add("contrast-theme");
  // change the theme toggle icon
  themeToggle.classList.replace("ri-sun-line","ri-eye-2-line");
  // update the selected theme in localStorage
